...
public class FireCar extends Car{
    ...
    * */
    ...
    public FireCar (){
        ...
        *   명시적, 묵시적 전부 사용이 가능하다.
        * */
        super();            // 부모의 기본생성자 호출 (Ctrl+클릭하면 연결된 곳 확인가능), 상속되어있으니 부모의 것도 가지고 있다.
    ...
    * */
    ...
    public void soundHorn(){
        ...
        if(isRunning()) {
            ...
            * */
            ...
            System.out.println("빵아아아아아앙아아~빵빵~~~~~~~~");

        } else {

            System.out.println("소방차가 앞을 갈 수가 없습니다...비켜주세요 제발");
        }
    ...
    public void sprayWater(){
        System.out.println("불난 곳을 발견했습니다..!! 물을 뿌릴께요=============>>>>>>>>>");
