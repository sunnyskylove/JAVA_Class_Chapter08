...
public class Application {
    public static void main(String[] args) {
         ...
         *   부모가 가지고 있는 재산(자바에서 클래스가 가지는 멤버)을 자식이 물려받는 의미이다.
         ...
         *  물려 받아서 자신의 것 처럼 사용하는 것 뿐 아니라 추가적인 멤버(필드/메소드)도 작성이 가능하다.
         ...
         *  메소드 재정의 하면 메소드를 호출할 시 재정의 한 메소드가 우선적으로 동작하게 된다.
         *
         * 필기.
         ...
         *   [ 예시: fireCar is a car (o) / car is a fireCar (x) //어디에 포함되어 있느냐]
         *
         * 필기.
